...
from {{ cookiecutter.package_name }}.core.logger import setup_logging
from {{ cookiecutter.package_name }}.models import DEFAULT_CONFIG, CLIConfig

CONFIG_EXT = ".yml"
CONFIG_PATH = Path.home() / ".config" / "{{ cookiecutter.package_name }}" / f"config{CONFIG_EXT}"
